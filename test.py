...
class Test(unittest.TestCase):
    ...
    def test11(self):
        dog_1 = AnimalFactory.create("Dog", "dog_1", 2, 10)
        cat_1 = AnimalFactory.create("Cat", "cat_1", 2, 15)
        shop = Shop("Avital_Shop", 1000)
        self.assertEqual(shop + [dog_1, cat_1], 2)
        self.assertEqual(shop.play("dog_1", "cat_1"), "cat_1 winner\ndog_1 loser")
